...
animation_ddim.save("ani_run_ddim.gif")
...
animation_ddpm_context.save("ani_run_ddim_context.gif")
...
print(timeit.timeit(lambda: sample_ddim(32, n=25), number=1))
print(timeit.timeit(lambda: sample_ddpm(32, ), number=1))
