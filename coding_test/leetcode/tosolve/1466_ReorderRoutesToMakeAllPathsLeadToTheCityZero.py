...
Output: 3
Explanation: Change the direction of edges such that each node can reach city 0 (capital).
...
if __name__ == "__main__":
    # Test cases
    tests = [
        (6, [[0, 1], [1, 3], [2, 3], [4, 0], [4, 5]]),  # Example 1
        (5, [[1, 0], [1, 2], [3, 2], [3, 4]]),  # Example 2
        (3, [[1, 0], [2, 0]]),  # Example 3
    ]
    answers = [
    ...
    tester = Tester(Solution().minReorder)
